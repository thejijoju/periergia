      ...
      },
      {
        ...
        "children": [
          ...
          },
          {
            ...
            "summary": "How Britain broke China in the nineteenth century. The problem: the British East India Company faced a China that had everything Britain wanted — tea, silk, porcelain — but wanted almost nothing in return, so the trade deficit was hemorrhaging British silver into the Qing treasury. The solution: opium. The Company grew it in India and smuggled it into China through Canton (Guangzhou), the empire's richest port and the one place foreigners could trade — turning the flow of silver around. By the 1830s China was drowning: on the order of 12 million addicts, and Chinese silver now flowing OUT to pay for the drug, wrecking the currency and the tax base. The drug supply chain was run by the most powerful empire on earth. The reckoning: the Daoguang Emperor ordered Commissioner Lin Zexu to shut it all down; in 1839 Lin seized and destroyed some 1,000 tons of opium at Humen and wrote his famous open letter to Queen Victoria demanding Britain stop the trade ('By what right do they … use the poisonous drug to injure the Chinese people?'). Britain answered with warships. The First Opium War (1839–1842) and the Treaty of Nanjing — the first of the 'unequal treaties' — ceded Hong Kong, opened the treaty ports, imposed indemnities and extraterritoriality; the Second Opium War (1856–1860) ended with British and French troops burning the Old Summer Palace. This is the opening of China's 'century of humiliation,' a wound that still shapes Chinese nationalism today. Quote from Lin Zexu's 1839 letter to Queen Victoria (a real, translated primary source — do not invent wording); include an image (e.g. {{image: Lin Zexu | Commissioner Lin Zexu, who was ordered to end the opium trade}} or the destruction of opium at Humen). Continues in Modern China."
          },
          {
            "title": "Modern China",
