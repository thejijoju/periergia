      ...
      },
      {
        ...
        "children": [
          ...
          },
          {
            ...
            "summary": "The past written with nature in it: how climate, disease, soils, plants, and animals shaped human history — and how humans remade the earth; the Columbian exchange (Crosby's ecological imperialism); the Little Ice Age and the seventeenth-century crisis; deforestation, irrigation, and empire; the Dust Bowl (Worster); industrialization, energy transitions from wood to coal to oil, and pollution; disease environments from the Plague of Justinian to smallpox to malaria (McNeill); conservation versus preservation (Pinchot, Muir), national parks, and environmentalism from Silent Spring (1962) to Earth Day; climate change and the Anthropocene debate; and the field's founders and classics — Crosby, Worster, Cronon's Changes in the Land and Nature's Metropolis."
          },
          {
