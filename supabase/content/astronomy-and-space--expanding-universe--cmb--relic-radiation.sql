...
{{image: Cosmic microwave background | The measured spectrum of the cosmic microwave background against the Planck blackbody curve at 2.72548 K. The error bars are smaller than the plotted line width — deviations are bounded below fifty parts per million of the peak — which makes this the most precise blackbody spectrum ever recorded. The significance is that thermalisation to this standard requires photon-number-changing processes operating at high density, so no mechanism available in a transparent universe can produce it.}}
