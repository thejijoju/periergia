...
Scarcity is why choice is unavoidable. If resources were unlimited, nothing would have to be given up to get anything else, and there would be no economic problem to study — everyone could have everything at once. Because they are limited, every choice is fenced in by **constraints**: a household by its income and the hours in a day, a firm by its budget and its plant, a government by what it can tax and borrow. So at bottom economics is the study of **allocation** — how scarce resources get parcelled out among the many uses competing for them: which goods a society makes, who ends up with them, and on what terms. That, ultimately, is the question the whole subject exists to answer.

The bite of scarcity is clearest with a resource almost everyone would take in unlimited supply and no one can conjure on demand. Oil is the obvious case. Roughly a fifth of the world's crude is shipped through the **Strait of Hormuz**, a channel under 40 kilometres wide at its neck; when conflict in the region flared in 2025 and Iran threatened to close it, prices jumped within hours — not because a single barrel had yet stopped flowing, but because the mere prospect of the supply tightening was enough to change what the world would pay. Fresh water tells the same story from the other side: Egypt draws almost all of its from a single river, and Ethiopia's filling of the **Grand Ethiopian Renaissance Dam** upstream turned one shared, finite flow into a decade-long standoff over who is entitled to how much. In each case a thing everyone wants is made precious precisely because the supply is fixed and contested — and in each, the question that follows is the economic one: who gets how much, and on what terms.
...
An hour spent studying is an hour not spent earning; land used for housing is land not used for farming; a government's spending on one programme is spending unavailable for every other. This is why the trade-offs mentioned above sit at the heart of the subject: scarcity forces choices, constraints bound them, and opportunity cost is what each one really costs. The demand and supply curves in the pages ahead are, in the end, a way of drawing how a market allocates scarce goods through price when many people make these constrained choices at once.
