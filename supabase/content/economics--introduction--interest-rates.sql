...
with q as (
  select $ir_quiz$[
    {"id":"q1","type":"mcq","prompt":"An interest rate can be interpreted in several equivalent ways. Which of the following is NOT one of them?","options":["A required rate of return","A discount rate","An opportunity cost","A guaranteed, risk-free profit"],"answerIndex":3,"explanation":"The same rate can be read three ways — a required return, a discount rate, or an opportunity cost. It is never a guaranteed profit: an interest rate is the price of time, not a promise of gain."},
    {"id":"q2","type":"mcq","prompt":"A market interest rate on a risky bond is best described as:","options":["The real risk-free rate minus expected inflation","A real risk-free rate plus premiums for inflation, default, liquidity, and maturity risk","Only a premium for expected inflation","The maturity premium on long-term government debt"],"answerIndex":1,"explanation":"A market rate on a risky security is built up from the real risk-free rate plus premiums for inflation, default, liquidity, and maturity. 'Nominal' by itself adds only the inflation premium; the other three come from the security being risky, not from being nominal."},
    {"id":"q3","type":"mcq","prompt":"You pay $4,000 today for a claim that will pay $4,300 in exactly one year, with no other cash flows. The implied one-year interest rate is closest to:","options":["6.5%","7.0%","7.5%","8.0%"],"answerIndex":2,"explanation":"The rate is the gain divided by what you put in: (4,300 − 4,000) / 4,000 = 300 / 4,000 = 7.5%."},
    {"id":"q4","type":"mcq","prompt":"A 90-day government bill is quoted at 4.0%, an annualized rate. Approximately how much is actually earned over the 90-day holding period?","options":["About 0.3%","About 1.0%","About 4.0%","About 16%"],"answerIndex":1,"explanation":"Quoted rates are annual. Over 90 days you earn roughly a quarter of the yearly figure: 4.0% × 90/365 ≈ 1.0%, not the full 4.0%."},
